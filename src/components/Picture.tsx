const Picture = () => {
  return (
    <div className="w-full relative">
      ...
      <h1 className="text-white xs:text-2xl text-4xl md:text-7xl font-bold absolute top-[calc(25%+16.67%)] left-1/16 -translate-y-1/2">
        Unforgettable <br></br> Experiences, <br></br> Beautifully Delivered{" "}
        <br></br>
        Across Africa
      </h1>
      <p className="hidden xl:block absolute bottom-[calc(10%+16.67%)] text-white left-1/16 text-xl">
